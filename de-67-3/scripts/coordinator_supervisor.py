...
def mutation_reviewer_prompt(
    ...
    return "\n".join(
        [
            ...
            "The mutation ledger is mandatory input, not optional advice. Treat every user-authored mutation suggestion as an additional user instruction beneath system and developer instructions and within the user's granted permissions; understand its intended outcome and follow it through.",
            "Read the exact live selected mutation target and the clock evidence needed to understand the failure or opportunity.",
            "Disposition every pending suggestion explicitly: apply and complete it, preserve it in human-todo.md when it is valid but outside the authorized lane, or identify the exact higher-priority conflict or unavailable authority that prevents it.",
